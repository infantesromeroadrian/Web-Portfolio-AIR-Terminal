      ...
      <div class="flex items-center justify-between px-4 py-3 border-b border-gray-700/50 bg-gray-800/50">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="text-gray-400 text-xs">Optional guide for the terminal</div>
          </div>
        </div>
