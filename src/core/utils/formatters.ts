 ...
 * Muestra puertos "abiertos" del portfolio con servicios ficticios.
 */
 ...
 * Datos ficticios pero creíbles para demostrar observabilidad.
 */
export function formatThreatMap(): string {
  // Generar datos "aleatorios" pero consistentes en la misma sesión
 ...
 * Genera logs ficticios con anomalías detectadas por ML.
 */
